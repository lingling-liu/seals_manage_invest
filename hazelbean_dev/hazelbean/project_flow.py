...
class  ProjectFlow(object):
    ...
    def execute(self, args=None):
        ...
        self.temporary_dir = getattr(self, 'temporary_dir', os.path.join(hb.config.TEMPORARY_DIR))  # Generates new run_dirs here. Useful also to set the numdal temporary_dir to here for the run.

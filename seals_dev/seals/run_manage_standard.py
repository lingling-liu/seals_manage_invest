...
if __name__ == '__main__':
    ...
    p.projected_crs = 32645        # crs for the project. It should be changed based on location of the country. It is required for InVEST models. We ar using 7755 for IND, 32736 for TZA, 32645 for BGD
